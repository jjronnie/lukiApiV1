<x-app-layout>
    <x-admin.page-header title="Commission Rules" subtitle="Configure commission percentages and types">
        <x-slot name="actions">
            <a class="btn" href="{{ route('admin.commission-rules.create') }}">
            ...
            <table class="w-full text-left text-sm">
                <thead class="border-b border-gray-100 bg-gray-50/50">
                    <tr>
                        ...
                        <th class="px-5 py-3.5 font-semibold text-gray-600">Value</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @foreach($rules as $rule)
                        <tr class="transition-colors hover:bg-gray-50/50">
                            ...
                            <td class="px-5 py-3.5 text-gray-600">{{ $rule->commission_type->value ?? $rule->commission_type }}</td>
                            <td class="px-5 py-3.5 font-medium text-gray-900">{{ $rule->value }}</td>
                            ...
                            <td class="px-5 py-3.5">
                                <a class="btn btn-light text-xs" href="{{ route('admin.commission-rules.edit', $rule) }}">Edit</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
